...
import rapidjson
from generateHeader import addHeader, addAdventureNoteHeader
...
def convert2BDSPNoteTitle(message, labelIndex, arrayIndex, printOutput = True, label = None):
    ...
    for word in messageArray:
        ...
        if word != '\n' and '\n' not in word and '\\r' not in word and '\\f' not in word and '\\w' not in word and "<name>" not in word:
            ...
            if subTotal[subTotalCounter] + wordLength > maxStrWidth:
                newMessage[newMessageCounter] = newMessage[newMessageCounter].replace("'", "’")
    ...
    if label == None:
        ...
        return addAdventureNoteHeader(output, labelIndex, arrayIndex, label, True)

def convert2BDSPNoteText(message, labelIndex, arrayIndex, printOutput = True, label = None):
    ...
    if label == None:
        ...
        return addAdventureNoteHeader(output, labelIndex, arrayIndex, label, False)
